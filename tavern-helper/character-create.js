// @name         [助手]斗罗大陆 I-IV · Soul Land 角色创建 @0.6.7
...
(function () {
  ...
  const PAGE_INDEX = 1;
  const BUILD_ID = "character-create@0.6.7+4197b678a5b4";
